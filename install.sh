...
# Create or overwrite .gitpod.yml in the workspace directory
if [[ -f "$GITPOD_CONFIG" ]]; then
  echo "⚠️  Existing .gitpod.yml found. Overwriting..."
else
  echo "📝 Creating new .gitpod.yml"
fi
...
echo "✅ $GITPOD_CONFIG has been (re)created successfully!"
